    ...
    function(username, password, done) {
        process.nextTick(function() {
            ...
            ChatUsers.findOne({
                ...
                if (user) {
                    sails.log.info('Account has been login:' + username);
                    return done(null, false, {
                        sError: 'Account has been login.'
                    });
                } else {
                    Users.findOne({
                        username: username
                        ...
                        if (!user) {
                            sails.log.info('Login access Incorrect username:' + username);
                            return done(null, false, {
                                sError: 'Incorrect username.'
                            });
                        }
                        if (!user.validPassword(password)) {
                            sails.log.info('Login access Incorrect password:' + username);
                            return done(null, false, {
